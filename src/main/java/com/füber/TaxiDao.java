...
public class TaxiDao {
	...
	public Object fetchActiveTaxiByLocation(int latitude, int longitude,boolean isPink) {
		return col.find(new BasicDBObject("latitude", new BasicDBObject("$gt",latitude - 10)
				.append("$lte", latitude + 10))
				.append("longitude",new BasicDBObject("$gt", longitude - 10)
				.append("$lte",longitude + 10))
				.append("isPink", isPink)
